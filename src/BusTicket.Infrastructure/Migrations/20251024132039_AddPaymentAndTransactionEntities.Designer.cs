...
namespace BusTicket.Infrastructure.Migrations
{
    ...
    [Migration("20251024132039_AddPaymentAndTransactionEntities")]
    partial class AddPaymentAndTransactionEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusTicket.Domain.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("BusTicket.Domain.Entities.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("transactions", "busticket");
                });
            ...
            modelBuilder.Entity("BusTicket.Domain.Entities.Payment", b =>
                {
                    ...
                    b.OwnsOne("BusTicket.Domain.ValueObjects.Money", "Amount", b1 =>
                        {
            ...
            modelBuilder.Entity("BusTicket.Domain.Entities.Transaction", b =>
                {
                    b.HasOne("BusTicket.Domain.Entities.Payment", "Payment")
